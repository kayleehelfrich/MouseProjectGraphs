...
setwd("~/KayleeStuff/Smith_Lab/Data/Mouse_Validation_Data/Maternal_BMP6")

#reads a file in a table format and creates a data frame from it
datafile <- "MatLivBMP6_Ctcalcs_file1_For_ddCtDotPlot.csv"
...
png("Maternal_BMP6_ddCtDotPlot_B&W.png", units="in", width=5, height=7, res=600)
...
p<- ggplot(dataframe_AdjCtCalcs, aes(x=Biological.Sets, y=mean)) + 
  ...
  ggtitle("Maternal Bmp6 Expression") +
