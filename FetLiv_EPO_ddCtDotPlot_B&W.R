...
setwd("~/KayleeStuff/Smith_Lab/Data/Mouse_Validation_Data/Fetal_EPO")

#reads a file in a table format and creates a data frame from it
datafile <- "FetLivEPO_Ctcalcs_file1_For_ddCtDotPlot.csv"
...
png("FetLiv_EPO_ddCtDotPlot_B&W.png", units="in", width=5, height=7, res=600)
