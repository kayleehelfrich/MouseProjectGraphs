...
setwd("~/KayleeStuff/Smith_Lab/Data/Mouse_Validation_Data/Maternal_Hepcidin")

#reads a file in a table format and creates a data frame from it
datafile <- "MatLivHEPC_Ctcalcs2_file1_ddCt_DotPlot.csv"
...
png("MatLiv_Hepcidin_ddCtDotPlot_B&W.png", units="in", width=5, height=7, res=600)
