...
setwd("~/KayleeStuff/Smith_Lab/Data/Mouse_Validation_Data/Fetal_IL6")

#reads a file in a table format and creates a data frame from it
datafile <- "FetLivIL6_Ctcalcs1_file1_For_ddCtDotPlot.csv"
...
png("FetLiv_Il6_ddCtDotPlot_B&W.png", units="in", width=2.5, height=7, res=600)
