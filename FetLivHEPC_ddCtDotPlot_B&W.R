...
setwd("~/KayleeStuff/Smith_Lab/Data/Mouse_Validation_Data/Fetal_Hepcidin")

#reads a file in a table format and creates a data frame from it
datafile <- "FetLivHEPC_Ctcalcs2woutOutlier_COMBINED_ddCtDotPlot.csv"
...
png("FetLiv_Hepcidin_ddCtDotPlot_B&W.png", units="in", width=5, height=7, res=600)
