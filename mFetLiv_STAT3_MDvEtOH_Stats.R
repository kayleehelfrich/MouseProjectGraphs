...
File <- "FetLiv_pSTAT_STAT3_TP_FinalValues.csv"
...
sets <- data.frame(MD$pSTAT3.STAT3.TP)
sets$PAE <- PAE$pSTAT3.STAT3.TP
...
shapiro.test(data_frame$pSTAT3.STAT3.TP)
hist(data_frame$pSTAT3.STAT3.TP)
qqnorm(data_frame$pSTAT3.STAT3.TP)
qqline(data_frame$pSTAT3.STAT3.TP)
