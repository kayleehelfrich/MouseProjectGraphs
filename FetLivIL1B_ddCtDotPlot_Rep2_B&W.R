...
setwd("~/KayleeStuff/Smith_Lab/Data/Mouse_Validation_Data/Fetal_IL1B")

#reads a file in a table format and creates a data frame from it
datafile <- "FetLivIL1B_Ctcalcs_Rep2_For_ddCtDotPlot.csv"
...
png("FetLiv_Il1B_ddCtDotPlot_B&W.png", units="in", width=2.5, height=7, res=600)
