...
setwd("~/KayleeStuff/Smith_Lab/Data/Mouse_Validation_Data/Fetal_TNFa")

#reads a file in a table format and creates a data frame from it
datafile <- "FetLivTNFa_Ctcalcs_file1_For_ddCtDotPlot.csv"
...
png("FetLiv_Tnfa_ddCtDotPlot_B&W.png", units="in", width=2.5, height=7, res=600)
